...
namespace ReactApp1.Server.Service
{
    public interface IItemService
    {
        ...
        List<ItemModel> GetItemsByType(int itemType);
...
public class ItemService : IItemService
{
    ...
    public List<ItemModel> GetAllItems() => _items.ToList();
    public List<ItemModel> GetItemsByType(int itemType) => _items.Where(i => i.ItemType == itemType).ToList();
    public ItemModel GetItemById(int id) => _items.FirstOrDefault(i => i.Id == id);
}
